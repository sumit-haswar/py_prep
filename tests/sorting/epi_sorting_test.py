...
class EpiSortingTestCase(unittest.TestCase):
    ...
    def test_intersect_two_sorted_lists_binary_search(self):
        result = intersect_two_sorted_lists_binary_search([2, 3, 3, 5, 5, 6, 7, 7, 8, 12], [5, 5, 6, 8, 8, 9, 10, 10])
        self.assertListEqual([5, 6, 8], result)

        result = intersect_two_sorted_lists_binary_search(
            [-9, -5, -1, 2, 3, 3, 5, 7, 8, 10],
            [-15, -13, -8, -8, -6, -1, 0, 2, 2, 8, 11, 13, 13, 14, 15],
        )
        self.assertListEqual([-1, 2, 8], result)

    def test_intersect_two_sorted_lists(self):
        result = intersect_two_sorted_lists([2, 3, 3, 5, 5, 6, 7, 7, 8, 12], [5, 5, 6, 8, 8, 9, 10, 10])
        self.assertListEqual([5, 6, 8], result)

        result = intersect_two_sorted_lists(
            [-9, -5, -1, 2, 3, 3, 5, 7, 8, 10],
            [-15, -13, -8, -8, -6, -1, 0, 2, 2, 8, 11, 13, 13, 14, 15],
        )
        self.assertListEqual([-1, 2, 8], result)
    ...
    def test_merge_sorted_arrays(self):
        result = merge_sorted_arrays([-1, 0, 0, 0, 0], 1, [-3, -1, 0, 3], 4)
    ...
    def test_get_h_index(self):
        ...
        self.assertEqual(10, get_h_index([0, 21, 14, 15, 16, 19, 6, 13, 20, 13, 24, 15, 7]))
    ...
    def test_add_interval(self):
        ...
        intervals = [[interval.left, interval.right] for interval in intervals]
    ...
    def test_union_of_intervals(self):
        ...
        intervals = [Interval(interval[0], interval[2], interval[1], interval[3]) for interval in intervals]
        ...
        for idx, interval in enumerate(union):
            ...
            curr = [interval.left, interval.right]
