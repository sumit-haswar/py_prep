...
class EpiLinkedListsTestCase(unittest.TestCase):
    ...
    def test_merge_sorted_list(self):
        ...
        self.assertListEqual(get_list_from_linked_list(actual), expected)
    ...
    def test_reverse_sublist(self):
        ...
        self.assertListEqual([11, 7, 5, 6, 4, 3, 2], get_list_from_linked_list(head))

        link_list = create_list([11, 7, 4, 6, 5, 3, 22, 9, 2])
        head = reverse_sublist(link_list, 2, 7)
        self.assertListEqual([11, 22, 3, 5, 6, 4, 7, 9, 2], get_list_from_linked_list(head))
    ...
    def test_remove_last_kth_node(self):
        ...
        self.assertListEqual([2, 4, 6, 8, 12, 14], get_list_from_linked_list(head_a))

        remove_last_kth_node(head_a, 4)
        self.assertListEqual([2, 4, 8, 12, 14], get_list_from_linked_list(head_a))
    ...
    def test_remove_duplicates(self):
        ...
        self.assertListEqual([2, 4, 6, 8, 10, 12, 14], get_list_from_linked_list(head))
    ...
    def test_remove_all_duplicates_(self):
        ...
        self.assertListEqual([2], get_list_from_linked_list(head))

    def test_even_odd_merge(self):
        pass

    def test_is_palindromic(self):
        self.assertTrue(is_palindromic(create_list([2, 4, 5, 5, 4, 2])))
        self.assertTrue(is_palindromic(create_list([2, 4, 5, 6, 5, 4, 2])))
        self.assertFalse(is_palindromic(create_list([2, 4, 5, 6, 5, 3, 2])))
