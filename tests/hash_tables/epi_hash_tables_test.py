...
class EpiHashTablesTestCase(unittest.TestCase):
    ...
    def test_get_longest_subarray_with_distinct_values(self):
        self.assertEqual(3, get_longest_subarray_with_distinct_values([1, 2, 1, 3, 1, 2, 1]))
        ...
        self.assertEqual(7, get_longest_subarray_with_distinct_values([6, 59, 49, 35, 77, 17, 86]))
    ...
    def test_get_longest_contained_interval(self):
        self.assertEqual(6, get_longest_contained_interval([3, -2, 7, 9, 8, 1, 2, 0, -1, 5, 8]))
