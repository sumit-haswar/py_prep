...
from graphs.misc_graph import create_mst_kruskal, create_mst_prims, dijkstra, Node
...
class MiscGraphTestCase(unittest.TestCase):
    ...
    def test_dijkstra(self):
        ...
        expected_distance = {"a": 0, "b": 5, "g": 7, "f": 11, "c": 11, "e": 10, "d": 12}
    ...
    def _create_graph(self):
        ...
        graph = {"a": a, "b": b, "c": c, "d": d, "e": e, "f": f, "g": g}
