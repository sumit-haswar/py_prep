...
from recursion import generate_permutation, generate_permutation_iter, get_phone_mnemonic
...
class EpiRecursionTestCase(unittest.TestCase):
    ...
    def test_generate_permutation(self):
        ...
        self.assertListEqual([[0, 1, 2], [0, 2, 1], [1, 0, 2], [1, 2, 0], [2, 1, 0], [2, 0, 1]], result)

    def test_generate_permutation_iter(self):
        result = generate_permutation_iter([0, 1, 2])
        self.assertListEqual([[0, 1, 2], [0, 2, 1], [1, 0, 2], [1, 2, 0], [2, 0, 1], [2, 1, 0]], result)
